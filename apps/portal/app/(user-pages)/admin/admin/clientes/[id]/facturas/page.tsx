...
import { FacturasCliente } from "@/components/clientes/facturas-cliente"
...
export default function FacturasClientePage() {
  ...
  const handleExportar = () => {
    console.log("Exportando facturas del cliente")
    ...
    <div className="container mx-auto py-6">
      ...
      <div className="mb-6 flex items-center justify-between gap-4">
        <div className="flex items-center gap-4">
          ...
          <h1 className="text-2xl font-bold text-gray-900">Facturas - {cliente.razonSocial}</h1>
        </div>
