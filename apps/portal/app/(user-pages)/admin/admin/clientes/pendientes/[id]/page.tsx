...
export default function DetalleClientePendientePage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const cliente = clientesPendientesData[id as keyof typeof clientesPendientesData]
  ...
  const handleApproveCliente = () => {
    ...
    setTimeout(() => {
      router.push("/admin/admin/clientes/pendientes")
    }, 1500)
  }
  ...
  return (
    <div className="container mx-auto py-6">
      <div className="flex items-center gap-4 mb-6">
        <Button variant="outline" size="icon" onClick={() => router.push("/admin/admin/clientes/pendientes")}>
          <ArrowLeft className="h-4 w-4" />
        </Button>
        <h1 className="text-2xl font-bold">Detalle del Cliente Pendiente</h1>
      </div>
            ...
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <p className="mt-1">{cliente.fechaSolicitud}</p>
                </div>
              </div>
