...
export default function MisVisitasAdmin() {
  ...
  const visitas: Visita[] = [
    {
      ...
      descripcion: "Visita de inspección laboral",
      personasDetalle: [
        {
          id: "1",
          nombre: "Juan Pérez",
    ...
    },
    {
      ...
      descripcion: "Descarga de materiales importados",
      personasDetalle: [],
      vehiculosDetalle: [],
    },
    {
      ...
      descripcion: "Mantenimiento de sistemas de ventilación",
      personasDetalle: [],
      vehiculosDetalle: [],
    },
    {
      ...
      descripcion: "Inspección de buque",
      personasDetalle: [],
      vehiculosDetalle: [],
    },
    {
      ...
      descripcion: "Carga de contenedores para exportación",
      personasDetalle: [],
      vehiculosDetalle: [],
    },
    {
      ...
      descripcion: "Reunión de coordinación con proveedores",
      personasDetalle: [],
      vehiculosDetalle: [],
    },
    {
      ...
      descripcion: "Obras de ampliación del muelle norte",
      personasDetalle: [],
      vehiculosDetalle: [],
    },
  ]
  ...
  const handleVerDetalle = (id: string) => {
    // Navegar a la página de detalle en lugar de abrir el modal
    router.push(`/admin/admin/visitas/mis-visitas/${id}`)
  }
      ...
      <div className="flex justify-between items-center">
        ...
        <div className="flex gap-2">
          ...
          <Button className="bg-black hover:bg-gray-800 flex items-center gap-2 w-15">
            <Link href="/admin/admin/visitas/nueva-visita">
            ...
            <div className="relative">
              <Select value={tipoVisita} onValueChange={setTipoVisita} onOpenChange={setShowTipoOptions}>
                ...
                <SelectContent>
                  ...
                  <SelectItem value="transporte">Transporte cargas</SelectItem>
                  <SelectItem value="obras">Obras/mantenimiento</SelectItem>
                  <SelectItem value="muelle">Acceso a muelle</SelectItem>
                </SelectContent>
              </Select>
              {showTipoOptions && (
                <div className="absolute top-full left-0 w-full bg-white border border-gray-200 rounded-md shadow-md z-10 mt-1">
                  ...
                  <div className="p-2 hover:bg-gray-100 cursor-pointer flex items-center">
                    <input
                      type="checkbox"
                      checked={tipoVisita === "transporte"}
                      onChange={() => setTipoVisita("transporte")}
                      className="mr-2"
                    />
                    <span>Transporte cargas</span>
                  </div>
                  <div className="p-2 hover:bg-gray-100 cursor-pointer flex items-center">
                    <input
                      type="checkbox"
                      checked={tipoVisita === "obras"}
                      onChange={() => setTipoVisita("obras")}
                      className="mr-2"
                    />
                    <span>Obras/mantenimiento</span>
                  </div>
                  <div className="p-2 hover:bg-gray-100 cursor-pointer flex items-center">
                    <input
                      type="checkbox"
                      checked={tipoVisita === "muelle"}
                      onChange={() => setTipoVisita("muelle")}
                      className="mr-2"
                    />
                      ...
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end">
                          <DropdownMenuItem 
                            ...
                            onClick={() => setTimeout(() => handleVerDetalle(visita.id), 0)}
                          >
                          ...
                          {visita.estado === "Pendiente" && (
                            <>
                              <DropdownMenuItem 
                                ...
                                onClick={() => setTimeout(() => handleAceptar(visita.id), 0)}
                              >
                              ...
                              <DropdownMenuItem 
                                ...
                                onClick={() => setTimeout(() => handleRechazar(visita.id), 0)}
                              >
