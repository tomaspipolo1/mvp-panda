...
export default function LicitacionesAdmin() {
  return (
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6">
        ...
        <div className="flex gap-3">
          ...
          <Button asChild className="flex items-center gap-2">
            <Link href="/admin/gestion/licitaciones/nueva">
                    ...
                    <tr key={index} className="hover:bg-gray-50">
                      ...
                      <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-500 text-center">
                        <div className="flex justify-center space-x-2">
                          <Button variant="ghost" size="icon" className="h-8 w-8" title="Ver detalle" asChild>
                            <Link href={`/admin/gestion/licitaciones/detalle/${index + 1}`}>
