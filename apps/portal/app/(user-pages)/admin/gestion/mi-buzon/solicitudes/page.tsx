...
export default function SolicitudesAdminPage() {
  ...
  const [solicitudSeleccionadaChat, setSolicitudSeleccionadaChat] = useState<SolicitudAdmin | null>(null)
  ...
  const solicitudesExternas: SolicitudAdmin[] = [
    {
      id: 1,
  ...
  const solicitudesEmpleados: SolicitudAdmin[] = [
    {
      id: 6,
    ...
    },
    {
      ...
      comentarios: [
        ...
        "18/02/2024 - Admin Principal: En revisión",
      ],
      firmantes: [
        {
          id: 1,
    ...
    },
    {
      ...
      comentarios: [
        ...
        "20/02/2024 - Admin Principal: Aprobada",
      ],
      firmantes: [
        {
          id: 1,
    ...
    },
    {
      ...
      comentarios: [
        ...
        "19/02/2024 - Admin Principal: Aprobada",
      ],
      firmantes: [
        {
          id: 1,
    ...
    },
    {
      ...
      comentarios: [
        ...
        "21/02/2024 - Admin Principal: Rechazada - Documentación incompleta",
      ],
      firmantes: [
        {
          id: 1,
  ...
  const filterSolicitudesExternas = (solicitudes: SolicitudAdmin[]) => {
  ...
  const filterSolicitudesEmpleados = (solicitudes: SolicitudAdmin[]) => {
    return solicitudes.filter((solicitud) => {
      const matchesNumero = numeroSolicitud === "" || solicitud.numero.includes(numeroSolicitud)
      const matchesEstado = estadoFilter === "Todos" || solicitud.estado === estadoFilter
  ...
  const handleOpenApproveModal = (solicitud: SolicitudAdmin) => {
    setIsApproveModalOpen(true)
  }

  const handleOpenRejectModal = (solicitud: SolicitudAdmin) => {
    setIsRejectModalOpen(true)
  }

  const handleOpenChatModal = (solicitud: SolicitudAdmin) => {
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
        ...
        <TabsContent value="recibidas" className="space-y-6">
          <div className="flex justify-between items-center">
            <h1 className="text-2xl font-bold">Solicitudes Externas - Administración</h1>
                          ...
                          <DropdownMenu>
                            ...
                            <DropdownMenuContent align="end">
                              <DropdownMenuItem asChild>
                                <Link href={`/admin/gestion/mi-buzon/solicitudes/externos/${solicitud.id}`} className="flex items-center">
        ...
        <TabsContent value="pendientes" className="space-y-6">
          <div className="flex justify-between items-center">
            <h1 className="text-2xl font-bold">Solicitudes de Empleados - Administración</h1>
            <div className="flex space-x-2">
              <Button variant="outline" className="flex items-center">
                <Printer className="mr-2 h-4 w-4" />
                Imprimir
                      ...
                      <tr key={solicitud.id} className="border-b border-gray-200 hover:bg-gray-50">
                        ...
                        <td className="px-4 py-4 text-sm text-center">
                          <DropdownMenu>
                            ...
                            <DropdownMenuContent align="end">
                              <DropdownMenuItem asChild>
                                <Link href={`/admin/gestion/mi-buzon/solicitudes/empleados/${solicitud.id}`} className="flex items-center">
                                  <Eye className="mr-2 h-4 w-4" />
                                  Ver detalle
                                </Link>
                              </DropdownMenuItem>
