...
// Tipos para las solicitudes de clientes
...
const buildHistorialEventos = (solicitud: SolicitudCliente): ActionEvent[] => {
...
export default function DetalleSolicitudClientePage({ params }: { params: Promise<{ id: string }> }) {
  ...
  // Datos de ejemplo para solicitudes de clientes
  const solicitudesClientes: SolicitudCliente[] = [
    {
      id: 1,
      ...
      correo: "juan.perez@constructora-abc.com",
      comentarios: [
    ...
    },
    {
      ...
      descripcion: "Solicito certificado de cumplimiento de servicios recibidos durante el año 2023 para presentar en auditoría interna.",
      fecha: "10/04/2023",
      estado: "En proceso",
    ...
    },
    {
      ...
      tipo: "Consulta",
      tipoSolicitante: "Cliente",
      asunto: "Información sobre servicios portuarios",
      descripcion: "Quisiera obtener más información sobre los servicios disponibles en el puerto respecto a los horarios de operación.",
      fecha: "28/03/2023",
      estado: "Rechazada",
      ...
      comentarios: [
        ...
        "30/03/2023 - Administrador: Esta consulta debe realizarse a través del sistema de atención al cliente. Por favor, utilice la opción 'Contacto' en el menú principal.",
      ],
      adjuntos: [
    ...
    },
    {
      ...
      comentarios: [
        ...
        "21/03/2023 - Juan Pérez: Solicitud cancelada por el usuario",
      ],
      adjuntos: [
  ...
  const solicitud = solicitudesClientes.find(s => s.id === parseInt(resolvedParams.id)) || solicitudesClientes[0]

  // Hook para manejar el chat
  const { mensajes, enviarMensaje } = useChat({
    chatId: solicitud.numero,
    usuarioActual: 'Juan Pérez' // En producción vendría del contexto de usuario
  })
    ...
    <div className="container mx-auto py-6 space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-4">
          <Link href="/cliente/gestion/solicitudes/mis-solicitudes">
