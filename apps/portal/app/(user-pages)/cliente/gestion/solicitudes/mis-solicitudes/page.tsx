...
const solicitudesData = [
  ...
  },
  {
    ...
    descripcion:
      "Solicito certificado de cumplimiento de servicios recibidos durante el año 2023 para presentar en auditoría interna.",
    comentarios: [
      {
        id: "c1",
        fecha: "12/04/2023",
  ...
  },
  {
    ...
    descripcion:
      "Quisiera obtener más información sobre los servicios disponibles en el puerto respecto a los horarios de operación.",
    comentarios: [
      {
        id: "c1",
        fecha: "30/03/2023",
        usuario: "Administrador",
        texto:
          "Esta consulta debe realizarse a través del sistema de atención al cliente. Por favor, utilice la opción 'Contacto' en el menú principal.",
      },
    ],
    historial: [
      {
...
export default function MisSolicitudesPage() {
  ...
  const handleVerDetalle = (solicitud: any) => {
    router.push(`/cliente/gestion/solicitudes/mis-solicitudes/${solicitud.id}`)
  }
  ...
  const handleNuevaSolicitud = () => {
    router.push("/cliente/gestion/solicitudes/nueva-solicitud")
  }
