...
const solicitudesExternas: SolicitudDepartamento[] = [
  {
    id: 101,
    numero: "SOL-DEPT-3001",
    tipo: "Reclamo",
    tipoSolicitante: "Proveedor",
    asunto: "Solicitud de Redeterminación - Contrato de Servicios Portuarios",
    descripcion: "Solicito la redeterminación del contrato de servicios portuarios debido al incremento en los costos de combustible y mano de obra. Adjunto documentación justificativa.",
    fecha: "15/01/2024",
    estado: "En proceso",
    ...
    leido: false,
    prioridad: "Media",
    contenido: "Solicito la redeterminación del contrato de servicios portuarios debido al incremento en los costos de combustible y mano de obra. Adjunto documentación justificativa.",
  },
  {
    id: 102,
    numero: "SOL-DEPT-3002",
    tipo: "Reclamo",
    tipoSolicitante: "Cliente",
    asunto: "Reclamo por Demora en Descarga de Contenedores",
    descripcion: "Presento formal reclamo por la demora excesiva en la descarga de contenedores del buque 'Mar del Plata' el día 12/01/2024. La demora generó sobrecostos operativos.",
    fecha: "15/01/2024",
    estado: "En proceso",
    ultimaActualizacion: "15/01/2024",
    ...
    leido: true,
    prioridad: "Media",
    contenido: "Presento formal reclamo por la demora excesiva en la descarga de contenedores del buque 'Mar del Plata' el día 12/01/2024. La demora generó sobrecostos operativos.",
  },
  {
    id: 103,
    numero: "SOL-DEPT-3003",
    tipo: "Tramite",
    tipoSolicitante: "Proveedor",
    asunto: "Cambio de Datos - Actualización Información Bancaria",
    descripcion: "Solicito el cambio de datos bancarios para el pago de facturas. Adjunto certificación bancaria con los nuevos datos de la cuenta corriente.",
    fecha: "14/01/2024",
    estado: "Resuelta",
    ...
    leido: true,
    prioridad: "Baja",
    contenido: "Solicito el cambio de datos bancarios para el pago de facturas. Adjunto certificación bancaria con los nuevos datos de la cuenta corriente.",
  },
  {
    id: 104,
    numero: "SOL-DEPT-3004",
    tipo: "Consulta",
    tipoSolicitante: "Cliente",
    asunto: "Consulta sobre Tarifas de Almacenaje",
    descripcion: "Consulto sobre las tarifas vigentes para almacenaje de granos en silos. Necesito cotización para almacenamiento de 5000 toneladas de soja por 60 días.",
    fecha: "14/01/2024",
    estado: "En proceso",
    ultimaActualizacion: "14/01/2024",
    ...
    leido: false,
    prioridad: "Media",
    contenido: "Consulto sobre las tarifas vigentes para almacenaje de granos en silos. Necesito cotización para almacenamiento de 5000 toneladas de soja por 60 días.",
  },
]
