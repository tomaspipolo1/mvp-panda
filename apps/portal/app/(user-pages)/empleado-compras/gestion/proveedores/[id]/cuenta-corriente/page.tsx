...
import { CuentaCorrienteProveedor } from "@/components/proveedores/cuenta-corriente-proveedor"
    ...
    return (
      <div className="container mx-auto py-6">
        <div className="text-center">
          ...
          <Button onClick={() => router.push("/empleado-compras/gestion/proveedores/listado")}>
            Volver al listado
          </Button>
        </div>
      </div>
    ...
    <div className="container mx-auto py-6">
      ...
      <div className="mb-6 flex items-center justify-between gap-4">
        <div className="flex items-center gap-4">
          <Button
            variant="ghost"
            onClick={() => router.push("/empleado-compras/gestion/proveedores/listado")}
            className="flex items-center gap-2"
          >
            <ArrowLeft className="h-4 w-4" />
            Volver al listado
          </Button>
          <h1 className="text-2xl font-bold text-gray-900">Cuenta Corriente - {proveedor.razonSocial}</h1>
        </div>
