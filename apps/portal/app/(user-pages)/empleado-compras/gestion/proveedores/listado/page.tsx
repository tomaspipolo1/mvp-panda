...
export default function ListadoProveedoresPage() {
  ...
  const handleVerDetalle = (proveedor: Proveedor) => {
    router.push(`/empleado-compras/gestion/proveedores/detalle/${proveedor.id}`)
  }
  ...
  const handleCuentaCorriente = (proveedor: Proveedor) => {
    router.push(`/empleado-compras/gestion/proveedores/${proveedor.id}/cuenta-corriente`)
  }

  // Función para ver facturas
  const handleFacturas = (proveedor: Proveedor) => {
    router.push(`/empleado-compras/gestion/proveedores/${proveedor.id}/facturas`)
  }
