...
// Datos de ejemplo para visitas del empleado de compras
const visitasEmpleadoCompras: Visita[] = [
  {
    id: "1",
    numero: "VIS-2024-001",
...
export default function DetalleVisitaEmpleadoComprasPage({ params }: { params: Promise<{ id: string }> }) {
  const router = useRouter()
  const resolvedParams = use(params)

  // Buscar la visita según el ID
  const visita = visitasEmpleadoCompras.find((v) => v.id === resolvedParams.id) || visitasEmpleadoCompras[0]
  ...
  const historialEventos: ActionEvent[] = [
    ...
    },
    {
      ...
      type: "info",
      message: "María Fernández aprobó la solicitud",
      actor: "María Fernández",
      detail: "Departamento de Seguridad",
    },
    {
      id: "evt-4",
