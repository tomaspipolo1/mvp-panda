...
// Tipos para las solicitudes del departamento contable

type SolicitudContable = {
  id: number
  fecha: string
  numero: string
  solicitante: string
...
export default function SolicitudesContablePage() {
  ...
  const [solicitudSeleccionadaChat, setSolicitudSeleccionadaChat] = useState<SolicitudContable | null>(null)
  ...
  const solicitudesExternas: SolicitudContable[] = [
    {
      id: 1,
  ...
  const solicitudesEmpleados: SolicitudContable[] = [
    {
      id: 6,
  ...
  const filterSolicitudesExternas = (solicitudes: SolicitudContable[]) => {
  ...
  const filterSolicitudesEmpleados = (solicitudes: SolicitudContable[]) => {
    return solicitudes.filter((solicitud) => {
      const matchesNumero = numeroSolicitud === "" || solicitud.numero.includes(numeroSolicitud)
      const matchesEstado = estadoFilter === "Todos" || solicitud.estado === estadoFilter
  ...
  const handleOpenApproveModal = (solicitud: SolicitudContable) => {
    setIsApproveModalOpen(true)
  }

  const handleOpenRejectModal = (solicitud: SolicitudContable) => {
    setIsRejectModalOpen(true)
  }

  const handleOpenChatModal = (solicitud: SolicitudContable) => {
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
        ...
        <TabsContent value="recibidas" className="space-y-6">
          <div className="flex justify-between items-center">
            <h1 className="text-2xl font-bold">Solicitudes Externas - Contable</h1>
                          ...
                          <DropdownMenu>
                            ...
                            <DropdownMenuContent align="end">
                              <DropdownMenuItem asChild>
                                <Link href={`/empleado-contable/gestion/mi-buzon/solicitudes/externos/${solicitud.id}`} className="flex items-center">
        ...
        <TabsContent value="pendientes" className="space-y-6">
          <div className="flex justify-between items-center">
            <h1 className="text-2xl font-bold">Solicitudes de Empleados - Contable</h1>
            <div className="flex space-x-2">
              <Button variant="outline" className="flex items-center">
                <Printer className="mr-2 h-4 w-4" />
                Imprimir
                      ...
                      <tr key={solicitud.id} className="border-b border-gray-200 hover:bg-gray-50">
                        ...
                        <td className="px-4 py-4 text-sm text-center">
                          <DropdownMenu>
                            ...
                            <DropdownMenuContent align="end">
                              <DropdownMenuItem asChild>
                                <Link href={`/empleado-contable/gestion/mi-buzon/solicitudes/empleados/${solicitud.id}`} className="flex items-center">
                                  <Eye className="mr-2 h-4 w-4" />
                                  Ver detalle
                                </Link>
                              </DropdownMenuItem>
