        ...
        <DialogContent className="sm:max-w-md">
          ...
          <div className="space-y-4">
            <div className="border rounded-md p-3 bg-gray-50">
              ...
              <div className="text-sm text-gray-500">Contacto: {proveedor.nombreContacto}</div>
              <div className="text-sm text-gray-500">CUIT: {proveedor.cuitCuil}</div>
              <div className="text-sm text-gray-500">
                Categorías: {proveedor.categoriasComerciales.map((cat) => cat.categoria).join(", ")}
              </div>
            </div>
