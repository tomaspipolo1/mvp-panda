...
export default function MisVisitasEmpleadoContable() {
  ...
  const handleVerDetalle = (id: string) => {
    ...
    router.push(`/empleado-contable/visitas/mis-visitas/${id}`)
  }
      ...
      <div className="flex justify-between items-center">
        ...
        <div className="flex gap-2">
          ...
          <Button className="bg-black hover:bg-gray-800 flex items-center gap-2 w-15">
            <Link href="/empleado-contable/visitas/nueva-visita">
