...
const empleadoSchema = z.object({
  ...
  estadoCivil: z.enum(["soltero", "casado", "divorciado", "viudo", "otro"], { required_error: "El estado civil es obligatorio" }),
  grupoSanguineo: z.enum(["O+", "O-", "A+", "A-", "B+", "B-", "AB+", "AB-"], { required_error: "El grupo sanguíneo es obligatorio" }),
  hijos: z.enum(["si", "no"]),
  telefonoEmergencia: z.string().optional().default(""),
  contactoEmergencia: z.string().optional().default(""),
  direcciones: z
    .array(
      z.object({
        id: z.string(),
  ...
  conyuge: z
    .object({
      nombreCompleto: z.string().min(2, { message: "El nombre es obligatorio" }),
      dni: z.string().min(7, { message: "El DNI es obligatorio" }),
      fechaNacimiento: z.date({ required_error: "La fecha de nacimiento es obligatoria" }),
    })
    .optional(),
  hijosDatos: z
    ...
    .optional()
    .default([]),
  licencias: z.array(z.object({ periodo: z.number(), dias: z.number().min(0, { message: "Debe ser un número positivo" }) })).length(3),
  diaTramite: z.object({ periodo: z.number(), dias: z.number().min(0, { message: "Debe ser un número positivo" }) }),
})
...
export default function AltaEmpleadoPage() {
  ...
  const defaultValues: Partial<EmpleadoFormValues> = {
    ...
    cuil: "20284567893",
    legajo: "LEG-9210",
    fechaIngreso: new Date("2018-04-10"),
    gerencia: "GA",
    departamento: "COMP",
    cargo: "PROFMED",
    email: "carlos.martinez@plp.gob.ar",
    telefono: "01147896543",
    telefonoEmpresa: "01147896544",
    estado: "activo",
    ...
    grupoSanguineo: "A+",
    hijos: "si",
    telefonoEmergencia: "01147896545",
    ...
    conyuge: {
      nombreCompleto: "María Elena Martínez",
      dni: "25432198",
      fechaNacimiento: new Date("1982-08-20"),
      ocupacion: "Contadora",
      telefono: "01147896546"
    },
    hijosDatos: [
      {
      ...
      },
      {
        ...
        fechaNacimiento: new Date("2012-07-22"),
        dni: "47123456"
      }
    ]
  }
      ...
      <div className="mb-6">
        <div className="flex items-center gap-4">
          <Button
            variant="outline"
            size="sm"
            onClick={() => router.push("/empleado-compras/perfil/datos-personales")}
          ...
          <div>
            ...
            <p className="text-muted-foreground">Edite los datos del empleado</p>
          </div>
        </div>
      </div>
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div className="grid gap-4 md:grid-cols-2">
                {/* Nombre, Apellido, DNI, CUIL, Fecha Nacimiento, Sexo */}
                <FormField
                  control={form.control}
                  name="nombre"
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder="Ingrese el nombre" {...field} disabled />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder="Ingrese el apellido" {...field} disabled />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder="Ingrese el CUIL (sin guiones)" {...field} disabled />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <DatePickerModal date={field.value} setDate={field.onChange} placeholder="Seleccione fecha" disabled />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                />
                {/* Nacionalidad, Estado Civil, Grupo Sanguíneo, Hijos */}
                <FormField
                  control={form.control}
                  name="nacionalidad"
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder="Ingrese la nacionalidad" {...field} disabled />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <Select onValueChange={field.onChange} value={field.value} disabled>
                        <FormControl>
                          <SelectTrigger>
                            <SelectValue placeholder="Seleccione si" />
                          </SelectTrigger>
                        </FormControl>
                        <SelectContent>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder="Ingrese el número de legajo" {...field} disabled />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <Select onValueChange={(value) => handleGerenciaChange(value)} defaultValue={field.value} disabled>
                        <FormControl>
                          <SelectTrigger>
            ...
            <CardContent className="space-y-4">
              <div className="grid gap-4 md:grid-cols-2">
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder="Ingrese el teléfono de emergencia" {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>Nombre de Contacto de Emergencia (opcional)</FormLabel>
                      <FormControl>
                        <Input placeholder="Ingrese el nombre de contacto de emergencia" {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Establezca la ubicación exacta en el mapa</CardDescription>
            </CardHeader>
            <CardContent>
              <p className="text-sm text-gray-600 mb-4">
                Haga clic en el mapa para establecer la ubicación exacta. Las coordenadas se actualizarán automáticamente en los campos de dirección.
              </p>
              <MapaSelector
                initialPosition={[-34.6037, -58.3816]}
                onChange={(coords) => {
                  console.log("Coordenadas actualizadas:", { latitud: coords[0], longitud: coords[1] }) // Debug log
                  if (direcciones.length > 0) {
                    const updatedDirecciones = direcciones.map((dir, index) => 
                      index === 0 ? { ...dir, latitud: coords[0].toString(), longitud: coords[1].toString() } : dir
                    )
              ...
              {estadoCivil === "casado" && (
                <div>
                  ...
                  <div className="grid gap-4 md:grid-cols-3">
                    <FormField
                      control={form.control}
                      name="conyuge.nombreCompleto"
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel>Nombre completo *</FormLabel>
                          <FormControl>
                            <Input placeholder="Ingrese el nombre completo del cónyuge" {...field} disabled />
                          </FormControl>
                          <FormMessage />
                        </FormItem>
                      )}
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel>DNI *</FormLabel>
                          <FormControl>
                            <Input placeholder="Ingrese el DNI del cónyuge" {...field} disabled />
                          </FormControl>
                          <FormMessage />
                        </FormItem>
                      )}
              ...
              {tieneHijos === "si" && (
                <div>
                  ...
                  <div className="space-y-2">
                    {hijosFields.map((hijo, idx) => (
                      <div key={hijo.id} className="grid gap-4 md:grid-cols-3 bg-gray-50 rounded-lg p-3">
                        <FormField
                          control={form.control}
                          name={`hijosDatos.${idx}.nombreCompleto`}
                          render={({ field }) => (
                            <FormItem>
                              <FormLabel>Nombre completo *</FormLabel>
                              <FormControl>
                                <Input placeholder="Ingrese el nombre completo del hijo" {...field} disabled />
                              </FormControl>
                              <FormMessage />
                            </FormItem>
                          )}
                        ...
                        <FormField
                          control={form.control}
                          name={`hijosDatos.${idx}.dni`}
                          render={({ field }) => (
                            <FormItem>
                              <FormLabel>DNI *</FormLabel>
                              <FormControl>
                                <Input placeholder="Ingrese el DNI del hijo" {...field} disabled />
                              </FormControl>
                              <FormMessage />
                            </FormItem>
                          )}
                        ...
                        <FormField
                          control={form.control}
                          name={`hijosDatos.${idx}.fechaNacimiento`}
                          render={({ field }) => (
                            <FormItem>
                              <FormLabel>Fecha de nacimiento *</FormLabel>
                              <FormControl>
