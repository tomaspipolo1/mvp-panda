...
const configGerente: ConfiguracionFormularioVisita = {
  tipoUsuario: "empleado-gerente",
...
export default function NuevaVisitaPage() {
  ...
  const cerrarModalYRedirigir = () => {
    ...
    router.push("/empleado-gerente/visitas/mis-visitas")
  }

  return (
    <>
      <FormularioNuevaVisitaReutilizable
        configuracion={configGerente}
        backUrl="/empleado-gerente/visitas/mis-visitas"
