...
import { ChevronDown, ChevronUp, Filter, Printer, Download, Plus, Eye, X, MoreVertical } from "lucide-react"
...
export default function MisSolicitudesPage() {
  ...
  const handleVerDetalle = (solicitud: any) => {
    router.push(`/empleado-legales/gestion/solicitudes/mis-solicitudes/${solicitud.id}`)
  }
      ...
      <div className="flex justify-between items-center">
        ...
        <div className="flex space-x-2">
          ...
          <Button asChild className="bg-blue-600 hover:bg-blue-700">
            <Link href="/empleado-legales/gestion/solicitudes/nueva-solicitud" className="flex items-center">
                      ...
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end">
                          ...
                          {(solicitud.estado === "En proceso" || solicitud.estado === "Aprobada") && (
                            <DropdownMenuItem onClick={() => handleCancelarDesdeTabla(solicitud)}>
