...
export default function NuevaSolicitudPage() {
  const [formData, setFormData] = useState({
    tipoSolicitud: "",
    tipoDocumento: "",
    tipoDato: "", // Nuevo campo para cambio de datos
    nombre: "Juan",
    apellido: "Pérez",
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-6">
          ...
          <div className="space-y-6">
             ...
             <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
               ...
               {formData.tipoSolicitud === "cambio_datos" && (
                 <div>
                   ...
                   <Select
                     ...
                     onValueChange={(value) => handleSelectChange("tipoDato", value)}
                   >
                     <SelectTrigger id="tipoDato" className="w-full">
                       <SelectValue placeholder="Seleccionar tipo de dato" />
                     </SelectTrigger>
                     <SelectContent>
                       <SelectItem value="datos_personales">Datos Personales</SelectItem>
                       <SelectItem value="datos_familiares">Datos Familiares</SelectItem>
                       <SelectItem value="datos_laborales">Datos Laborales</SelectItem>
                     </SelectContent>
                   </Select>
                 </div>
               )}
            ...
            {/* Superiores Jerárquicos - solo si NO es "otra solicitud" ni "cambio de datos" */}
            {formData.tipoSolicitud !== "otra" && formData.tipoSolicitud !== "cambio_datos" && (
              <div>
                <div className="flex justify-between items-center mb-2">
            ...
            <div>
              ...
              <Textarea
                ...
                placeholder={
                  formData.tipoSolicitud === "cambio_datos" 
                    ? "Describa detalladamente qué datos específicos desea modificar o agregar dentro del tipo de dato seleccionado..."
                    : "Describa detalladamente el motivo de su solicitud..."
                }
                rows={6}
                required
              />
