...
// Datos de ejemplo para solicitudes externas del departamento de prensa
const solicitudesExternas: SolicitudDepartamento[] = [
  {
    ...
    descripcion: "Solicitamos una entrevista con el Director del Puerto para cubrir las nuevas inversiones en infraestructura portuaria anunciadas para 2024.",
    fecha: "15/01/2024",
    estado: "En proceso",
    ...
    leido: false,
    prioridad: "Media",
    contenido: "Solicitamos una entrevista con el Director del Puerto para cubrir las nuevas inversiones en infraestructura portuaria anunciadas para 2024.",
  },
  {
    id: 102,
    ...
    descripcion: "Solicitamos autorización para realizar cobertura especial de la temporada de cruceros 2024. Necesitamos acceso a muelles y entrevistas.",
    fecha: "15/01/2024",
    estado: "En proceso",
    ultimaActualizacion: "15/01/2024",
    ...
    leido: true,
    prioridad: "Media",
    contenido: "Solicitamos autorización para realizar cobertura especial de la temporada de cruceros 2024. Necesitamos acceso a muelles y entrevistas.",
  },
  {
    id: 103,
    ...
    descripcion: "Solicitamos información actualizada sobre estadísticas de movimiento de cargas y pasajeros para programa especial sobre el puerto.",
    fecha: "14/01/2024",
    estado: "Resuelta",
    ...
    leido: true,
    prioridad: "Baja",
    contenido: "Solicitamos información actualizada sobre estadísticas de movimiento de cargas y pasajeros para programa especial sobre el puerto.",
  },
  {
    id: 104,
    ...
    descripcion: "Consultamos sobre los nuevos protocolos ambientales implementados en el puerto y su impacto en las operaciones.",
    fecha: "14/01/2024",
    estado: "En proceso",
    ultimaActualizacion: "14/01/2024",
    ...
    leido: false,
    prioridad: "Media",
    contenido: "Consultamos sobre los nuevos protocolos ambientales implementados en el puerto y su impacto en las operaciones.",
  },
  {
    id: 105,
    numero: "SOL-DEPT-5005",
    tipo: "Reclamo",
    tipoSolicitante: "Cliente",
    asunto: "Solicitud de Material Fotográfico",
    descripcion: "Solicitamos material fotográfico de alta resolución de las nuevas instalaciones portuarias para artículo especial.",
    fecha: "13/01/2024",
    estado: "En proceso",
    ...
    leido: true,
    prioridad: "Baja",
    contenido: "Solicitamos material fotográfico de alta resolución de las nuevas instalaciones portuarias para artículo especial.",
  },
]
    ...
    <div className="container mx-auto py-6 space-y-6">
      ...
      <div className="space-y-6">
          <div className="flex justify-between items-center">
            <h1 className="text-2xl font-bold">Solicitudes Externas - Departamento de Prensa</h1>
