...
export default function SolicitudesPrensaPage() {
  ...
  const [solicitudSeleccionadaChat, setSolicitudSeleccionadaChat] = useState<SolicitudPrensa | null>(null)
  ...
  // Datos de ejemplo para solicitudes externas (Proveedores, Clientes, medios, etc.)
  const solicitudesExternas: SolicitudPrensa[] = [
    {
      id: 1,
  ...
  const solicitudesEmpleados: SolicitudPrensa[] = [
    {
      id: 6,
  ...
  const filterSolicitudesExternas = (solicitudes: SolicitudPrensa[]) => {
  ...
  const filterSolicitudesEmpleados = (solicitudes: SolicitudPrensa[]) => {
    return solicitudes.filter((solicitud) => {
      const matchesNumero = numeroSolicitud === "" || solicitud.numero.includes(numeroSolicitud)
      const matchesEstado = estadoFilter === "Todos" || solicitud.estado === estadoFilter
  ...
  const handleOpenChatModal = (solicitud: SolicitudPrensa) => {
  ...
  const { mensajes, enviarMensaje } = useChat({
    ...
    usuarioActual: 'Ana García' // En producción vendría del contexto de usuario
  })
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
        ...
        <TabsContent value="recibidas" className="space-y-6">
          <div className="flex justify-between items-center">
            <h1 className="text-2xl font-bold">Solicitudes Externas - Prensa</h1>
                          ...
                          <DropdownMenu>
                            ...
                            <DropdownMenuContent align="end">
                              <DropdownMenuItem asChild>
                                <Link href={`/empleado-prensa/gestion/mi-buzon/solicitudes/externos/${solicitud.id}`} className="flex items-center">
        ...
        <TabsContent value="pendientes" className="space-y-6">
          <div className="flex justify-between items-center">
            <h1 className="text-2xl font-bold">Solicitudes de Empleados - Prensa</h1>
            <div className="flex space-x-2">
              <Button variant="outline" className="flex items-center">
                <Printer className="mr-2 h-4 w-4" />
                Imprimir
                      ...
                      <tr key={solicitud.id} className="border-b border-gray-200 hover:bg-gray-50">
                        ...
                        <td className="px-4 py-4 text-sm text-center">
                          <DropdownMenu>
                            ...
                            <DropdownMenuContent align="end">
                              <DropdownMenuItem asChild>
                                <Link href={`/empleado-prensa/gestion/mi-buzon/solicitudes/empleados/${solicitud.id}`} className="flex items-center">
                                  <Eye className="mr-2 h-4 w-4" />
                                  Ver detalle
                                </Link>
                              </DropdownMenuItem>
