...
// Datos de ejemplo para solicitudes externas del departamento de RRHH
const solicitudesExternas: SolicitudDepartamento[] = [
  {
    id: 101,
    numero: "SOL-RRHH-3001",
    tipo: "Reclamo",
    tipoSolicitante: "Candidato",
    asunto: "Reclamo por Proceso de Selección",
    descripcion: "Presento formal reclamo respecto al proceso de selección para el puesto de Supervisor Operativo. No se me informó adecuadamente sobre las etapas del proceso.",
    fecha: "15/01/2024",
    estado: "En proceso",
    ultimaActualizacion: "15/01/2024",
    solicitante: "Ricardo Gómez",
    departamento: "RRHH",
    correo: "ricardo.gomez@email.com",
    asignacion: "Sin asignar",
    adjuntos: ["postulacion.pdf", "comunicaciones.pdf"],
    hora: "14:30",
    leido: false,
    prioridad: "Media",
    contenido: "Presento formal reclamo respecto al proceso de selección para el puesto de Supervisor Operativo. No se me informó adecuadamente sobre las etapas del proceso.",
  },
  {
    id: 102,
    numero: "SOL-RRHH-3002",
    tipo: "Consulta",
    tipoSolicitante: "Proveedor",
    asunto: "Consulta sobre Programa de Capacitación Corporativa",
    descripcion: "Consulto sobre la posibilidad de presentar una propuesta de capacitación corporativa en liderazgo y gestión de equipos para el personal jerárquico.",
    fecha: "15/01/2024",
    estado: "En proceso",
    ultimaActualizacion: "15/01/2024",
    solicitante: "Instituto de Formación Empresarial",
    departamento: "RRHH",
    correo: "contacto@ife.com.ar",
    asignacion: "María González",
    adjuntos: ["presentacion_institucional.pdf"],
    hora: "11:15",
    leido: true,
    prioridad: "Media",
    contenido: "Consulto sobre la posibilidad de presentar una propuesta de capacitación corporativa en liderazgo y gestión de equipos para el personal jerárquico.",
  },
  {
    id: 103,
    numero: "SOL-RRHH-3003",
    tipo: "Tramite",
    tipoSolicitante: "Ex-empleado",
    asunto: "Solicitud de Certificado de Servicios",
    descripcion: "Solicito certificado de servicios prestados durante mi período laboral (2018-2023) para presentación en trámite jubilatorio.",
    fecha: "14/01/2024",
    estado: "Resuelta",
    ultimaActualizacion: "14/01/2024",
    solicitante: "Alberto Fernández Díaz",
    departamento: "RRHH",
    correo: "alberto.fdiaz@email.com",
    asignacion: "Carlos López",
    adjuntos: ["dni.pdf"],
    hora: "16:45",
    leido: true,
    prioridad: "Baja",
    contenido: "Solicito certificado de servicios prestados durante mi período laboral (2018-2023) para presentación en trámite jubilatorio.",
  },
  {
    id: 104,
    numero: "SOL-RRHH-3004",
    tipo: "Consulta",
    tipoSolicitante: "Familiar",
    asunto: "Consulta sobre Seguro de Vida",
    descripcion: "Soy beneficiaria del seguro de vida del empleado fallecido Sr. Jorge Martínez. Consulto sobre los pasos a seguir para iniciar el trámite de cobro.",
    fecha: "14/01/2024",
    estado: "En proceso",
    ultimaActualizacion: "14/01/2024",
    solicitante: "Silvia Martínez de López",
    departamento: "RRHH",
    correo: "silvia.mlopez@email.com",
    asignacion: "Sin asignar",
    adjuntos: ["acta_defuncion.pdf", "dni_beneficiario.pdf"],
    hora: "09:20",
    leido: false,
    prioridad: "Alta",
    contenido: "Soy beneficiaria del seguro de vida del empleado fallecido Sr. Jorge Martínez. Consulto sobre los pasos a seguir para iniciar el trámite de cobro.",
  },
]

// Datos de ejemplo para solicitudes de empleados del departamento de RRHH
const solicitudesEmpleados: SolicitudDepartamento[] = [
  {
    id: 201,
    numero: "SOL-RRHH-4001",
    tipo: "Licencia ordinaria anual",
    tipoSolicitante: "Empleado",
    asunto: "Solicitud de Licencia por Paternidad",
    descripcion: "Solicito licencia por paternidad de 15 días corridos a partir del 20/01/2024. Adjunto certificado de nacimiento.",
    fecha: "10/01/2024",
    estado: "En proceso",
    ...
    leido: false,
    prioridad: "Media",
    contenido: "Solicito licencia por paternidad de 15 días corridos a partir del 20/01/2024. Adjunto certificado de nacimiento.",
  },
  {
    id: 202,
    numero: "SOL-RRHH-4002",
    tipo: "Licencia medica",
    tipoSolicitante: "Empleado",
    asunto: "Consulta sobre Capacitación en Seguridad",
    descripcion: "Consulto sobre disponibilidad de capacitación en seguridad e higiene para personal operativo del turno noche.",
    fecha: "12/01/2024",
    estado: "En proceso",
    ultimaActualizacion: "12/01/2024",
    solicitante: "María Elena González",
    ...
    leido: true,
    prioridad: "Baja",
    contenido: "Consulto sobre disponibilidad de capacitación en seguridad e higiene para personal operativo del turno noche.",
  },
  {
    id: 203,
    numero: "SOL-RRHH-4003",
    tipo: "Reclamo",
    tipoSolicitante: "Empleado",
    asunto: "Reclamo por Liquidación de Sueldo",
    descripcion: "Reclamo por liquidación incorrecta de horas extra en el recibo de sueldo de diciembre 2023.",
    fecha: "13/01/2024",
    estado: "Aprobada",
    ultimaActualizacion: "13/01/2024",
    solicitante: "Roberto Silva Martinez",
  ...
  {
    id: 204,
    numero: "SOL-RRHH-4004",
    tipo: "Dia de tramite",
    tipoSolicitante: "Empleado",
    asunto: "Solicitud de Cambio de Horario",
    descripcion: "Solicito cambio de horario de trabajo por motivos familiares. Propongo horario de 7:00 a 15:00 hs.",
    fecha: "14/01/2024",
    estado: "En proceso",
    ultimaActualizacion: "14/01/2024",
    solicitante: "Ana Laura Fernández",
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
        ...
        <TabsContent value="externos" className="space-y-6">
          <div className="flex justify-between items-center">
            <h1 className="text-2xl font-bold">Solicitudes Externas - Departamento RRHH</h1>
        ...
        <TabsContent value="empleados" className="space-y-6">
          <div className="flex justify-between items-center">
            <h1 className="text-2xl font-bold">Solicitudes de Empleados - Departamento RRHH</h1>
            <div className="flex space-x-2">
              <Button variant="outline" className="flex items-center">
                <Printer className="mr-2 h-4 w-4" />
                Imprimir
