...
import { LegajoEmpleado } from "@/components/empleados/legajo/legajo-empleado"
import type { Empleado, LicenciaOrdinaria, DiaTramite } from "@/components/empleados/legajo/types"
import { ImagenAmpliadaModal } from "@/components/empleados/legajo/imagen-ampliada-modal"
...
type Empleado = {
  ...
  estadoCivil?: string // nuevo
  grupoSanguineo?: string // nuevo
  hijos?: boolean // nuevo
  conyuge?: Conyuge
  hijosDatos?: Hijo[]
  legajo: string
  ...
  telefonoEmergencia?: string // nuevo
  contactoEmergencia?: string // nuevo
...
export default function PerfilEmpleadoPage({ params }: { params: any }) {
  ...
  if (!empleadoId || !empleado) {
    // Puedes mostrar un loading o redirigir
    return (
