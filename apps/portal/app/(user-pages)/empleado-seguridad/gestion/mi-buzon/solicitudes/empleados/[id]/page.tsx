...
export default function DetalleSolicitudEmpleadoSeguridadPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  // Datos de ejemplo para solicitudes de empleados de seguridad
