...
export default function DetalleSolicitudExternaSeguridadPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  // Datos de ejemplo para solicitudes externas de seguridad
  const solicitudesExternas: SolicitudExterna[] = [
    {
      ...
      descripcion: "Presento reclamo formal por la demora excesiva en el control de acceso de nuestros camiones el día 10/02/2024. Los tiempos de espera superaron los 45 minutos, generando retrasos en nuestras operaciones.",
      fecha: "10/02/2024",
      estado: "Resuelta",
      ...
      comentarios: [
        ...
        "12/02/2024 - Carlos Méndez: Se implementó nuevo sistema de turnos para agilizar controles",
      ],
      adjuntos: [
        "reclamo-formal.pdf",
        "registro-tiempos.xlsx",
        "evidencia-demoras.pdf"
      ]
    },
    {
      id: 2,
      ...
      descripcion: "Consulto sobre los protocolos vigentes para el ingreso de materiales clasificados como peligrosos Clase 3 (líquidos inflamables).",
      fecha: "11/02/2024",
      estado: "En proceso",
      ...
      adjuntos: [
        "consulta-protocolos.pdf",
        "fichas-tecnicas-productos.pdf"
      ]
    },
    {
      id: 3,
      ...
      descripcion: "Solicitamos la renovación de credenciales de acceso permanente para 5 empleados que vencen el 28/02/2024. Adjuntamos documentación actualizada.",
      fecha: "12/02/2024",
      estado: "Rechazada",
      ...
      adjuntos: [
        ...
        "listado-personal.xlsx",
        "certificados-antecedentes.pdf"
      ]
    }
  ]
  ...
  const getClaseSolicitud = (tipo: string): string => {
    switch (tipo) {
      ...
      case "Consulta":
        return "Protocolos y Procedimientos"
      case "Tramite":
        return "Credenciales y Permisos"
      default:
        return "Otros"
    }
  }
  ...
  const getArchivosPorTipo = (tipo: string): ArchivoAdjunto[] => {
    switch (tipo) {
      case "Reclamo":
        return [
          { nombre: "Reclamo Formal", archivo: "reclamo-formal.pdf" },
          { nombre: "Registro de Tiempos", archivo: "registro-tiempos.xlsx" },
          { nombre: "Evidencia de Demoras", archivo: "evidencia-demoras.pdf" }
        ]
      case "Consulta":
        return [
          { nombre: "Documento de Consulta", archivo: "consulta-protocolos.pdf" },
          { nombre: "Fichas Técnicas", archivo: "fichas-tecnicas-productos.pdf" }
        ]
      case "Tramite":
        return [
          { nombre: "Solicitud de Renovación", archivo: "solicitud-renovacion.pdf" },
          { nombre: "Listado de Personal", archivo: "listado-personal.xlsx" },
          { nombre: "Certificados de Antecedentes", archivo: "certificados-antecedentes.pdf" }
        ]
      default:
        return []
    }
  ...
  const empleadosEjemplo = [
    "Ana Torres", "Carlos Méndez", "María Fernández", "Roberto Sánchez",
    "Diego Martínez", "Juan Pérez", "Sofía Ramírez"
  ]
