...
// Tipos para las solicitudes de seguridad
type SolicitudSeguridad = {
  id: number
  fecha: string
  numero: string
  solicitante: string
...
export default function SolicitudesSeguridadPage() {
  ...
  const [solicitudSeleccionadaChat, setSolicitudSeleccionadaChat] = useState<SolicitudSeguridad | null>(null)
  ...
  const solicitudesExternas: SolicitudSeguridad[] = [
    {
      id: 1,
      numero: "SOL-SEG-3001",
      tipo: "Reclamo",
      ...
      descripcion: "Presento reclamo formal por la demora excesiva en el control de acceso de nuestros camiones el día 10/02/2024.",
      fecha: "10/02/2024",
      estado: "Resuelta",
      ultimaActualizacion: "15/02/2024",
      solicitante: "Transportes Seguros S.A.",
      departamento: "Seguridad",
      correo: "operaciones@transportesseguros.com",
      asignacion: "Carlos Méndez",
      comentarios: [
        "10/02/2024 - Sistema: Solicitud creada",
        "12/02/2024 - Carlos Méndez: Se implementó nuevo sistema de turnos",
      ],
      firmantes: [],
    },
    {
      ...
      asunto: "Consulta sobre protocolos de ingreso de materiales peligrosos",
      descripcion: "Consulto sobre los protocolos vigentes para el ingreso de materiales clasificados como peligrosos Clase 3.",
      fecha: "11/02/2024",
      estado: "En proceso",
      ultimaActualizacion: "11/02/2024",
      solicitante: "Industrias Químicas del Sur",
      departamento: "Seguridad",
      correo: "seguridad@industriasquimicas.com",
    ...
    },
    {
      ...
      tipo: "Tramite",
      tipoSolicitante: "Proveedor",
      asunto: "Renovación de credenciales de acceso permanente",
      descripcion: "Solicitamos la renovación de credenciales de acceso permanente para 5 empleados que vencen el 28/02/2024.",
      fecha: "12/02/2024",
      estado: "Rechazada",
      ultimaActualizacion: "12/02/2024",
      solicitante: "Servicios Portuarios del Sur",
      departamento: "Seguridad",
      correo: "rrhh@serviciosportuarios.com",
  ...
  const solicitudesEmpleados: SolicitudSeguridad[] = [
    {
      id: 6,
      numero: "SOL-SEG-4001",
    ...
    },
    {
      ...
      comentarios: [
        ...
        "18/02/2024 - Jefe de Seguridad: En revisión",
      ],
      firmantes: [
        {
          id: 1,
    ...
    },
    {
      ...
      solicitante: "Diego Martínez",
      departamento: "Seguridad",
      correo: "diego.martinez@empresa.com",
      asignacion: "Gerente de RRHH",
      comentarios: [
        "17/02/2024 - Sistema: Solicitud creada",
        "20/02/2024 - Gerente de RRHH: Aprobada",
      ],
      firmantes: [
        {
          id: 1,
    ...
    },
    {
      ...
      comentarios: [
        ...
        "19/02/2024 - Jefe de Seguridad: Aprobada",
      ],
      firmantes: [
        {
          id: 1,
    ...
    },
    {
      ...
      comentarios: [
        ...
        "20/02/2024 - RRHH: Certificado emitido",
      ],
      firmantes: [
        {
          id: 1,
    ...
    },
    {
      ...
      comentarios: [
        ...
        "21/02/2024 - RRHH: Rechazada - Documentación incompleta",
      ],
      firmantes: [
        {
          id: 1,
  ...
  const filterSolicitudesExternas = (solicitudes: SolicitudSeguridad[]) => {
  ...
  const filterSolicitudesEmpleados = (solicitudes: SolicitudSeguridad[]) => {
    return solicitudes.filter((solicitud) => {
      const matchesNumero = numeroSolicitud === "" || solicitud.numero.includes(numeroSolicitud)
      const matchesEstado = estadoFilter === "Todos" || solicitud.estado === estadoFilter
  ...
  const handleOpenApproveModal = (solicitud: SolicitudSeguridad) => {
    setIsApproveModalOpen(true)
  }

  const handleOpenRejectModal = (solicitud: SolicitudSeguridad) => {
    setIsRejectModalOpen(true)
  }

  const handleOpenChatModal = (solicitud: SolicitudSeguridad) => {
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
        ...
        <TabsContent value="recibidas" className="space-y-6">
          <div className="flex justify-between items-center">
            <h1 className="text-2xl font-bold">Solicitudes Externas - Seguridad</h1>
                        ...
                        <td className="px-4 py-4 text-sm text-center">
                          <DropdownMenu>
                            ...
                            <DropdownMenuContent align="end">
                              <DropdownMenuItem onClick={() => router.push(`/empleado-seguridad/gestion/mi-buzon/solicitudes/externos/${solicitud.id}`)}>
        ...
        <TabsContent value="pendientes" className="space-y-6">
          <div className="flex justify-between items-center">
            <h1 className="text-2xl font-bold">Solicitudes de Empleados - Seguridad</h1>
            <div className="flex space-x-2">
              <Button variant="outline" className="flex items-center">
                <Printer className="mr-2 h-4 w-4" />
                Imprimir
                      ...
                      <tr key={solicitud.id} className="border-b border-gray-200 hover:bg-gray-50">
                        ...
                        <td className="px-4 py-4 text-sm text-center">
                          <DropdownMenu>
                            ...
                            <DropdownMenuContent align="end">
                              <DropdownMenuItem onClick={() => router.push(`/empleado-seguridad/gestion/mi-buzon/solicitudes/empleados/${solicitud.id}`)}>
                                <Eye className="mr-2 h-4 w-4" />
                                Ver detalle
                              </DropdownMenuItem>
