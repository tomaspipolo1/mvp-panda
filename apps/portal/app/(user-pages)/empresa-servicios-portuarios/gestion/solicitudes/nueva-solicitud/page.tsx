...
import { FormularioNuevaSolicitudEmpresaServiciosPortuarios } from "@/components/solicitudes/formulario-nueva-solicitud-empresa-servicios-portuarios"
  ...
  return (
    <div className="container mx-auto py-6">
      ...
      <div className="bg-white rounded-lg border border-gray-200 p-6">
        ...
        <FormularioNuevaSolicitudEmpresaServiciosPortuarios />
      </div>
    </div>
  )
}
