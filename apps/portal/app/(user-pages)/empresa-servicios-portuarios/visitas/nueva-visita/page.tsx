...
const configEmpresaServiciosPortuarios: ConfiguracionFormularioVisita = {
  tipoUsuario: "empresa-servicios-portuarios",
...
export default function NuevaVisitaPage() {
  ...
  return (
    <FormularioNuevaVisitaExternosReutilizable
      configuracion={configEmpresaServiciosPortuarios}
