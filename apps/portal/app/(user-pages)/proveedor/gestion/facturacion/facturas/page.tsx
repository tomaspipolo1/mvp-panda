...
import { DetalleFacturaProveedor } from "@/components/facturas/detalle-factura-proveedor"
    ...
    <div className="p-6">
      ...
      <DetalleFacturaProveedor
        ...
        onClose={() => {
          ...
          // Limpiar el documento seleccionado después de cerrar
          setTimeout(() => {
