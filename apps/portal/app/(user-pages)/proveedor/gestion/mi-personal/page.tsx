...
export default function MiPersonalPage() {
  ...
  const handleSaveNuevo = (data: { nombre: string; apellido: string; dni: string; telefono: string; imagen?: string }) => {
                ...
                {filteredPersonal.length > 0 ? (
                  filteredPersonal.map((person) => (
                    <TableRow key={person.id}>
                      ...
                      <TableCell className="font-medium">{person.apellido}</TableCell>
