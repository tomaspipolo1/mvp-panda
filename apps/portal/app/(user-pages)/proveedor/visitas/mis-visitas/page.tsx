...
import { visitasProveedor } from "./[id]/page"
...
export default function MisVisitasPage() {
  ...
  // Opciones de tipo de visita específicas para proveedor
  const tipoVisitaOptions = [
    { value: "todos", label: "Todos" },
    { value: "laboral", label: "Laboral" },
    { value: "acceso-muelle", label: "Acceso a Muelle" },
    { value: "obras-mantenimiento", label: "Obras/Mantenimiento" },
    { value: "transporte-cargas", label: "Transporte de cargas" },
  ]
  ...
  const handleOpenDetails = (visita: Visita) => {
    router.push(`/proveedor/visitas/mis-visitas/${visita.id}`)
  }
  ...
  return (
    <div className="p-6">
      <div className="flex justify-between items-center mb-6">
        ...
        <Link
          href="/proveedor/visitas/nueva-visita"
      ...
      {/* Tabla de visitas */}
      <TablaVisitas
        visitas={visitasProveedor.map((v) => ({
          id: v.id,
          fecha: v.fecha,
          hora: v.hora,
          tipo: v.tipo,
