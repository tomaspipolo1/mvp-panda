...
export function ResumenCards({ saldoActual, proximoVencimiento, montoFacturado2025 }: ResumenCardsProps) {
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
      ...
      <div className="bg-white rounded-lg border border-gray-200 p-4">
        <h3 className="text-gray-600 text-sm mb-2">Monto Facturado {montoFacturado2025.anio}</h3>
        <div className="flex items-center">
