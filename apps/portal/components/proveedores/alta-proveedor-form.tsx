...
import { showValidationError, showProviderCreated, showDraftSaved } from "@/lib/sweetalert"
...
interface AltaProveedorFormProps {
  draftId?: string
  readOnly?: boolean
  defaultData?: any
  backUrl?: string
...
export default function AltaProveedorForm({ draftId, readOnly, defaultData, backUrl = "/usuario-basico/gestion/mis-entidades" }: AltaProveedorFormProps) {
  ...
  // Deshabilitar todos los inputs en modo solo lectura
  useEffect(() => {
  ...
  const validateAndSubmit = (currentFormData?: any) => {
    ...
    showProviderCreated()
    console.log("Redirigiendo a mis-entidades...")
    router.push("/usuario-basico/gestion/mis-entidades")
    return true
  }
