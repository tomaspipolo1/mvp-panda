...
interface CuentaCorrienteProveedorProps {
  proveedorId: number
  proveedorNombre: string
  esVistaEmpleado?: boolean // true = vista empleado compras, false/undefined = vista proveedor
}
...
export function CuentaCorrienteProveedor({ 
  ...
  // Datos de resumen (en una app real vendrían del backend según el proveedorId)
  const resumenData = {
    saldoActual: {
      monto: "$1,250,430.75",
  ...
  return (
    <div className="space-y-6">
      {/* Header con acciones - Solo en vista proveedor */}
      {!esVistaEmpleado && (
      ...
      <TablaMovimientos
        ...
        ocultarAcciones={esVistaEmpleado}
      />
