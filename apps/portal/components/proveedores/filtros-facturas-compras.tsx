...
interface FiltrosFacturasComprasProps {
  onFilter: (filtros: FiltrosFacturasCompras) => void
}

export interface FiltrosFacturasCompras {
  busqueda: string
  estado: string
  fechaDesde: string
  fechaHasta: string
...
export function FiltrosFacturasCompras({ onFilter }: FiltrosFacturasComprasProps) {
