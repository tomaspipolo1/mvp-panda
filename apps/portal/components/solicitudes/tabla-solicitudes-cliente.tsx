                        ...
                        <Button variant="ghost" size="sm">
                         ...
                         <DropdownMenuItem 
                           ...
                           className={`cursor-pointer ${
                             (solicitud.tipo !== "Inscripción" && solicitud.tipo !== "Reinscripción") || solicitud.estado === "Pendiente"
                               ? "text-gray-400 cursor-not-allowed" 
                               : ""
                           }`}
                           disabled={(solicitud.tipo !== "Inscripción" && solicitud.tipo !== "Reinscripción") || solicitud.estado === "Pendiente"}
                         >
                           Editar
                           {(solicitud.tipo !== "Inscripción" && solicitud.tipo !== "Reinscripción") || solicitud.estado === "Pendiente" ? (
                             <span className="ml-2 text-xs text-gray-500">
                               {solicitud.tipo !== "Inscripción" && solicitud.tipo !== "Reinscripción" ? "(No editable)" : "(Solo pendientes)"}
                             </span>
                           ) : null}
                         </DropdownMenuItem>
