...
import { ChevronDown, ChevronUp, Eye, Mail, X, Edit } from "lucide-react"
...
interface Solicitud {
  ...
  tipo: string
  asunto: string
  estado: "En proceso" | "Resuelta" | "Cancelada" | "Rechazada"
                      ...
                      <DropdownMenuContent align="end" className="w-48">
                        ...
                        {onEditar && (
                          <DropdownMenuItem 
                            ...
                            disabled={solicitud.estado === "En proceso" || solicitud.estado === "En Proceso"}
                          >
