...
interface FormularioNuevaVisitaReutilizableProps {
...
export function FormularioNuevaVisitaReutilizable({
  configuracion,
  backUrl,
  onSubmit,
  onCancel,
  modoEdicion = false,
  datosPrecargados,
}: FormularioNuevaVisitaReutilizableProps) {
  ...
  const showSeccionVehiculos = !tipoVisita || tipoVisita === "Laboral"
  const showSeccionConductor = false
  ...
  return (
    <div className="p-6 max-w-7xl mx-auto">
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        ...
        {/* Sección Vehículos (formulario simple: Patente, Tipo, Marca, Modelo, Agregar) */}
        {showSeccionVehiculos && (
          <div className="bg-white p-6 rounded-lg border border-gray-200 shadow-sm">
            <div className="flex justify-between items-center mb-6">
              ...
              <Button
                type="button"
                variant="outline"
                onClick={agregarVehiculoDesdeForm}
                disabled={!patenteInput.trim() || !tipoVehiculoInput}
                className="flex items-center"
              >
                <Plus className="h-4 w-4 mr-2" />
                Agregar
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
              <div>
                <Label className="text-sm font-medium text-gray-700 mb-1 block">Patente</Label>
                <Input
                  value={patenteInput}
              ...
              <div>
                <Label className="text-sm font-medium text-gray-700 mb-1 block">Tipo de vehículo</Label>
                <Select value={tipoVehiculoInput} onValueChange={setTipoVehiculoInput}>
                  <SelectTrigger><SelectValue placeholder="Seleccionar" /></SelectTrigger>
                  <SelectContent>
                    {tiposVehiculoResuelto.map((t) => (
                      <SelectItem key={t} value={t}>{t}</SelectItem>
                    ))}
                  </SelectContent>
                </Select>
